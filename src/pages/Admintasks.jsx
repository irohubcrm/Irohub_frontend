...
import { FaAddressBook, FaBars, FaChevronDown, FaEdit, FaUserCircle } from 'react-icons/fa';
...
function Admintasks() {
    ...
    const filteredStaff = fetchstaffs?.data?.filter(staff => staff.role === selectedRole);
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 gap-4">
                    <div className="relative w-full sm:w-auto">
                        ...
                        >
                            <option className="bg-white text-blue-600" value="Sub-Admin">Subadmin</option>
                            <option className="bg-white text-blue-600" value="Agent">Agent</option>
                        </select>
                ...
                {fetchstaffs.isLoading ? (
                            ...
                            >
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div className="flex-1">
                                        <h4 className="font-semibold text-sm sm:text-base truncate w-40">{staff.name}</h4>
                    ...
                    <p className="text-gray-500 text-center text-lg py-6">No staff members available</p>
                )}
            </motion.div>
